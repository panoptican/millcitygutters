...
SEO sprints span weeks. Contexts compact, agents change, the user comes and goes. The roadmap doc (`.seo/roadmap.md`, or wherever `config.paths.roadmap` points) is the **single source of truth** that survives:
